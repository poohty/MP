...
export const DEFAULT_FEMALE_VOICE_ID = 'Cz0K1kOv9tD8l0b5Qu53'; // <-- Replace with your female ElevenLabs voice ID
export const DEFAULT_MALE_VOICE_ID = 'TX3LPaxmHKxFdv7VOQHJ'; // <-- Replace with your male ElevenLabs voice ID
